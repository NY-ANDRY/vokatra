        ...
        <>
            <AnimatePresence mode="wait">
                {openPanier &&
                    ...
                    <motion.div
                        {...bottom_top}
                        className="fixed flex flex-col z-50 p-2 pt-2 w-full top-8 left-0 xl:left-auto xl:p-4 xl:pt-2 xl:top-14 xl:right-12 bg-white shadow-md rounded-xl text-black xl:w-[800px] h-[80vh]">
