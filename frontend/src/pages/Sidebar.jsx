...
const SideBar = () => {
    ...
    const views = [
        { label: 'activites', link: '/stats/act' },
        { label: 'activite par sp', link: '/stats/sp' },
        { label: 'activite par membre', link: '/stats/act_membre' },
        { label: 'activite par membre et inviter', link: '/stats/act_membre_inviter' },
    ]
